            ...
            if (instance.timer.length === 1) {
                instance.timer.countdown(instance.options.countdownTo, function (event) {
                    ...
                    $this.html(event.strftime(
                        '<div class="col-xs-6 col-sm-3"><span class="day color">%D</span> <ins>day%!D</ins></div>' 
+ 
'<div class="col-xs-6 col-sm-3"><span>%H</span><ins class="cd1">hour%!D</ins></div>' 
+ 
'<div class="col-xs-6 col-sm-3"><span>%M</span><ins class="cd2">minute%!D</ins></div>' 
+ 
'<div class="col-xs-6 col-sm-3"><span class="csec">%S</span><ins class="cd3">second%!D</ins></div>'));
                });
            }
